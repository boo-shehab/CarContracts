    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 mt-4 gap-4">
        {cardsData.map((card, index) => (
          <div key={index} className="bg-[linear-gradient(218deg,_#DFEDFB_32.02%,_#C8E0F9_44.63%,_#91C2F2_74.12%)] shadow-[1px_2px_16px_0px_#4899EA1F] p-4 rounded-xl flex items-center gap-4">
            <div className="flex-1 flex flex-col gap-1">
              ...
              <div className="text-xl font-medium text-success-500 flex items-center">
                <span className="ml-1"><ArrowRise /></span> {card.trend}
              </div>
